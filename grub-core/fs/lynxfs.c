 ...
 * It is similar to ext2 in many important aspects.
 *
 * Inodes:
 ...
 * If the block_size = 512, then the real SuperBlock is in sector 1.
 *
 * Inode Block list:
 ...
 * last record in the block is padded to the next 512-byte boundary.
 *
 * Symlink entries:
